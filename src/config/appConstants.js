...
var STATUS_MSG = {
  ERROR: {
    ...
    NO_TASK_FOUND: {
      statusCode: 400,
      customMessage: "No Task Found",
      type: "NO_TASK_FOUND"
    },
    INVALID_TASK_TYPE: {
      statusCode: 400,
      customMessage: "Invalid Task Type",
      type: "INVALID_TASK_TYPE"
    },
    INPUT_ALL_CHOICES: {
      statusCode: 400,
      customMessage: "Input All Choices",
      type: "INPUT_ALL_CHOICES"
    },
    TRANSLATION_TEXT_MISSING: {
      statusCode: 400,
      customMessage: "Translation Text Missing",
      type: "TRANSLATION_TEXT_MISSING"
    },
    CORRECT_DECISION_MISSING: {
      statusCode: 400,
      customMessage: "Correct Decision Missing",
      type: "CORRECT_DECISION_MISSING"
    }
  },
  SUCCESS: {
    DEFAULT: {
